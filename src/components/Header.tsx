...
import { Menu, Globe, ChevronDown, Clock, Search, X } from 'lucide-react';
...
export default function Header() {
  ...
  return (
    <header className="w-full shadow-md z-50">
      {/* Bar 1: Language & Date */}
      <div className="bg-post-red-dark text-white py-2 px-6 text-xs flex justify-between items-center">
      ...
      <nav className="h-12 bg-post-red-primary text-white flex items-center px-6 relative z-40 shadow-lg">
        <div className="flex items-stretch h-full space-x-1">
          ...
          <div className="relative group flex items-center">
            ...
            >
              Others
              <ChevronDown size={14} className={isOthersOpen ? 'rotate-180 transition-transform' : 'transition-transform'} />
            </button>
