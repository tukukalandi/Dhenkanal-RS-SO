                ...
                {docs.map((doc, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`${theme.bg} p-2 md:p-3 rounded-lg shadow-md hover:shadow-xl transition-all flex flex-col gap-2 items-start group relative overflow-hidden h-full`}
                    >
                      ...
                      <div className="flex items-start gap-2 w-full z-10">
                        <div className={`${theme.iconBg} ${theme.iconColor} p-1.5 rounded-full shadow-inner flex-shrink-0`}>
                          <FileText size={14} className="md:w-4 md:h-4" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="font-black text-[10px] md:text-xs text-white uppercase tracking-tight mb-0.5 truncate">
                            {doc.fileName}
                          </h3>
                          <p className="text-[8px] md:text-[9px] text-white/70 font-bold uppercase tracking-tight mb-1 line-clamp-1">
                            {doc.subCategory || 'Official Record'}
                          </p>
                        </div>
                      </div>

                      <div className="w-full z-10 mb-1">
                        <p className="text-[8px] md:text-[9px] text-white/80 font-medium leading-relaxed line-clamp-2 h-6 md:h-7 opacity-90">
                          {doc.description || 'Official document archive entry for postal services and operational records.'}
                        </p>
                      </div>

                      <div className="mt-auto w-full flex items-center justify-between pt-2 border-t border-white/10 z-10">
                        <div className="flex flex-col">
                          <span className="text-[6px] font-black text-white/40 uppercase tracking-widest">UPLOADED</span>
                        ...
                        <a 
                          ...
                          className={`${theme.btnBg} ${theme.btnText} px-2.5 py-1 rounded-md text-[7px] font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow shadow-black/10 flex items-center gap-1`}
                        >
